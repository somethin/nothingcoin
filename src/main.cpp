...
uint256 hashGenesisBlock("0x8ca2e7b7187d5160211a54834b0efe49d4b90e51df3cdeb8071578204e3d899f");
...
const string strMessageMagic = "nothingcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // nothingcoin: 0.35 days
static const int64 nTargetSpacing = 15; // nothingcoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nothingcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nothingcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2b9730ea2d4d2043547e32dbe80c2d74fdee76f1b9ba6c42d7bbffbceec79b27");
    }
	...
	//  nTime=1366559428, nBits=1e0ffff0, nNonce=388214186, vtx=1)
